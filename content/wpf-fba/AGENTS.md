...
public sealed class MainWindow : Window
{
    public MainWindow()
    {
        ...
        var header = new TextBlock { FontSize = 16, Margin = new Thickness(0,0,0,12) };
        header.SetBinding(TextBlock.TextProperty, new Binding(nameof(CounterViewModel.Greeting)));
